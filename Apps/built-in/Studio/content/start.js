...
function loadAFile(path, type, element){
  fs.readFile(path, 'utf8', function(err, content){
    ...
    if(element.model !== undefined){
      ...
      var length = path.replace(/[^\\]/g, "").length, name = path;
      ...
      var tabs = document.getElementById("_tabs"), newTab = document.createElement("div"), img = document.createElement("img"), text = document.createElement("text"), closeButton = document.createElement("icon");
