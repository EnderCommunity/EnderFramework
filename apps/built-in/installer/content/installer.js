...
const loadingDiv = document.getElementById("loading"),
    dropAndSelectDiv = document.getElementById("COfDropOSelect"),
...
function getAFile(data) {
    ...
    const randomNumber = Math.floor(Math.random() * Math.floor(99999999999999)),
        unzipper = require("unzipper"),
        appTPath = path_ + "temporaryFiles\\" + randomNumber + "-" + data.name.substring(0, data.name.length - 4);
                        ...
                        fs.readFile(appTPath + "\\modules.data", 'utf8', function(err2, contents2) {
                            if (err2) {
                                ...
                                document.getElementById("_install").addEventListener("click", function() {
                                    ...
                                    setTimeout(function() {
                                        install(appTPath, data__.id, modules, permissions, data__.name);
                                    }, 500);
                                });
                                var COfModules = document.getElementById("_modules"),
                                    COfPermissions = document.getElementById("_capabilites");
                                var tModules = modules,
