...
function startFileManager(dir, callback = function() {}) {
    ...
    (function() {
        const fs = require("fs"),
            filesC = document.getElementById("_fileExplorer").getElementsByClassName("c")[0];
                                    ...
                                    addFile = (path) => {
                                        ...
                                        if (c._) {
                                            (function() {
                                                ...
                                                var options = c.__.e._contentElement.getElementsByClassName("item"),
                                                    done = false;
