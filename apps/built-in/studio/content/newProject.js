const newProjectLayout = document.getElementById("_newProjectLayout"),
    homePageElement = document.getElementById("_start"),
    templates = document.getElementsByClassName("template"),
    nextButton1 = document.getElementById("_newNextStep1"),
    firstScreen = document.getElementById("_projectType"),
    secondScreen = document.getElementById("_projectConfiguration"),
    projectType = document.getElementById("_currentPorjectType"),
    goBackToStep1 = document.getElementById("_goBack1"),
    createButton = document.getElementById("_createProject");
